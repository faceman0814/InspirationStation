...
using FaceMan.Utils.Configuration;
...
{
     /// <summary>Unique Name of the source.</summary>
    string Name { get; }

    /// <summary>This method is called by ABP before first usage.</summary>
    ...
    /// <summary>Gets all strings in current language.</summary>
    ...
    /// <summary>Gets all strings in specified culture.</summary>
    /// <param name="culture">culture information</param>
    /// <param name="includeDefaults">
    /// True: Fallbacks to default language texts if not found in current culture.
    /// </param>
