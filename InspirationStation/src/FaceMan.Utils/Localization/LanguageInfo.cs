...
public class LanguageInfo
{
    ...
    /// <summary>An icon can be set to display on the UI.</summary>
    public string Icon { get; set; }

    /// <summary>Is this the default language?</summary>
    public bool IsDefault { get; set; }

    /// <summary>Is this the language disabled?</summary>
    public bool IsDisabled { get; set; }

    /// <summary>Is this language Right To Left?</summary>
    public bool IsRightToLeft
    {
      get
      {
        try
        {
          TextInfo textInfo = CultureInfo.GetCultureInfo(this.Name).TextInfo;
          return textInfo != null && textInfo.IsRightToLeft;
        }
        catch
        {
          return false;
